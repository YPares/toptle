#!/usr/bin/env python3
"""
Test script to verify the improvements made to process_monitor_pty.py
"""
...
def test_basic_command():
    ...
    cmd = ["python3", "process_monitor_pty.py", "--interval", "0.5", "--", "sleep", "3"]
...
def test_interactive_preparation():
    ...
    print("1. Run: python3 process_monitor_pty.py --interval 1 -- vim test_vim.txt")
    print("2. Check if:")
    ...
    print("- htop: python3 process_monitor_pty.py -- htop")
    print("- less: python3 process_monitor_pty.py -- less test_vim.txt")
...
def verify_implementation():
    ...
    with open('process_monitor_pty.py', 'r') as f:
        content = f.read()
    
    improvements = {
        'Terminal size functions': 'get_terminal_size' in content and 'set_pty_size' in content,
        'SIGWINCH handling': 'handle_window_size_change' in content and 'SIGWINCH' in content,
        'Raw terminal mode': 'setup_raw_terminal' in content and 'restore_terminal' in content,
